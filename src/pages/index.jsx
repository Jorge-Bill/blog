  ...
  return (
    <LayoutHero {...props} bannerTags="images,travel,new-york">
      ...
      <S.MainContent>
        ...
        <S.CustomParagraphy>
          I love code and Javascript, this website was born to share knowledge and help anyone that's been this
          unexpected journey to become a web developer.
        </S.CustomParagraphy>
        <S.CustomParagraphy>Good luck, and Live long and prosper!</S.CustomParagraphy>
        <S.CustomParagraphy>
          If you want to know more about my carrer go to{' '}
          <AniLink to="/about/" title="About" cover direction="left" bg={getThemeColor()} duration={0.6}>
            About
          </AniLink>
          .
        </S.CustomParagraphy>
        <S.CustomParagraphy>
          If you want to read some articles go to{' '}
          <AniLink to="/posts/" title="Posts" cover direction="left" bg={getThemeColor()} duration={0.6}>
            Posts
          </AniLink>
          .
        </S.CustomParagraphy>
        ...
        <blockquote>
          <strong>“Where there's life there's hope, and need of vittles.”</strong> ― J.R.R. Tolkien, The Lord of the
          Rings
        </blockquote>
